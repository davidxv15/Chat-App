# Real-Time Chat Application in TypeScript + Vite     [![Netlify Status](https://api.netlify.com/api/v1/badges/1f4bf78a-7b9c-4489-a62f-4bb07937afb7/deploy-status)](https://app.netlify.com/sites/chat-department/deploys)
...
* **Inactivity Timer**: If you're inactive for a prolonged period, you'll receive a warning before being automatically logged out. Stay active to avoid being logged out automatically.  
* **Bulletin**:
...
* Chat Room Permissions: Create private rooms or password-protected rooms for departments, making this app ideal for workplace collaboration.
* File Sharing: Allow users to send files and images through the chat interface.
* Performance Upgrades: Improve the app to handle larger volumes of users and messages without impacting performance.
...
🌍 **Frontend (Netlify)**: [https://chat-department.netlify.app/](https://chat-department.netlify.app/)  
🚀 **Backend (Heroku)**: [https://sheltered-ocean-88159-0aef28cb17ba.herokuapp.com/](https://sheltered-ocean-88159-0aef28cb17ba.herokuapp.com/)  
