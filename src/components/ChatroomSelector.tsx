...
const ChatroomSelector: React.FC = () => {
  ...
  const rooms = ["General", "Tech", "Art", "Film", "Music", "Food", "Sports", "Resource"];
  ...
  return (
    <div className="flex flex-col items-center bg-gray-900 pb-6 full-screen-page"
    role="main" 
      ...
      >
        {rooms.map((room) => (
          <button
            ...
            className="bg-blue-700 text-xl text-gray-200 py-2 px-5 rounded border border-gray-500 hover:bg-blue-700 align-middle items-center justify-center"
