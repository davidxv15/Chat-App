...
const RecruiterAccordion = () => {
  ...
  return (
    <div
      className="max-w-md w-full mb-6 border border-yellow-500 rounded-2xl bg-gradient-to-br from-stone-600 via-stone-300 to-stone-500 shadow-lg text-black opacity-90"
      role="alert"
