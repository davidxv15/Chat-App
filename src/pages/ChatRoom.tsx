  ...
  return (
    <div className="chatroom-container sticky-header sticky">
      ...
      >
        <h1
          id="chat-title"
          className="text-2xl text-gray-800 dark:text-gray-400 flex justify-center items-center"
        >
          {" "}
          {roomName
    ...
    <ActiveUsersList roomName={roomName!} />
        ...
        <div
          className="flex-1 bg-white p-4 pt-2 rounded-lg shadow-md overflow-y-auto dark:bg-gray-800"
