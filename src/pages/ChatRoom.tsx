  ...
  return (
    <div className="chatroom-container sticky-header sticky">
      ...
      >
        <h1
          id="chat-title"
          className="text-2xl text-gray-800 dark:text-gray-300 flex justify-center items-center"
        >
          {" "}
          {roomName
    ...
    <ActiveUsersList roomName={roomName!} />
        ...
        <button
          ...
          className={`home-button font-bold bg-blue-500 text-white px-4 py-1 text-2xl rounded-md hover:bg-blue-800 dark:bg-blue-800 dark:text-gray-300 dark:hover:bg-blue-600 dark:hover:text-white sticky transition-all duration-500 ease-in-out ${
