...
>
  ...
  <div className="flex justify-between gap-6 text-sm font-mono text-gray-900">
    ...
    <div className="text-left border border-black p-2 rounded-md w-full">
      <p>Username: <code className="text-green-500">demo1</code></p>
      <p>Password: <code className="text-green-500">demo1</code></p>
    </div>

    {/* Second Set */}
    <div className="text-left border border-black p-2 rounded-md w-full">
      <p>Username: <code className="text-pink-600">demo2</code></p>
      <p>Password: <code className="text-pink-600">demo2</code></p>
    </div>
  </div>
</div>
